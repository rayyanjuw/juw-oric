      ...
      <div className="research-publication">
        ...
        <NavBar/>
          ...
          <div className='research-publication-card' >
              <h3 className='research-portfolio'>Research portfolio | Publications</h3>
              <div className='bred-crumb'>
                <Breadcrumb items={breadCrumps} activePath={currentPath} />
              </div>
                {publications.map((publication, index) => (
                 <div key={index} className={`card-content ${publication.new ? '' : 'mt-2'}` } >
        ...
        <button className='button' onClick={addMorePublications}>ADD MORE</button>
        </div>
